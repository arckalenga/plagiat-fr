...
export function validerDocument(fichier: Pick<File, "type" | "size">): string | null {
  ...
  if (fichier.size > TAILLE_MAX) return "Le fichier dépasse la taille maximale de 20 Mo.";
